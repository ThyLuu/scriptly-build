        ...
        <div className="flex-1 flex items-center justify-center">
            <form onSubmit={handleSubmit} className="relative max-w-[720px] w-full">
                <Input
                    ...
                    className="md:text-base placeholder:text-neutral-800 px-14 w-full border-none outline-none ring-0 ring-offset-0 focus-visible:ring-0 focus-visible:outline-none focus:shadow-[0_1px_1px_0_rgba(65,69,73,.3),0_1px_3px_1px_rgba(65,69,73,.15)] bg-[#F0F4F8] rounded-full h-[48px] focus:bg-white"
                />
